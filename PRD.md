...
| **Portadas chicas** | La de Valorant mide 295 × 171 y su card la muestra a 236; la de Cyberpunk, 480 × 270 en una card de 256. En pantallas retina las dos se ven blandas. El resto va sobrado (1080 a 3840). | Pedir el export grande. Es la misma familia de deuda que el peso de los assets, pero al revés. |
...
| Home | 🚧 | 🚧 | 🚧 En progreso — Header, menú y hero commiteados; Eventos, Leaderboard, Medallas, Misiones y Sura News esperando aprobación. Juegos y Footer, bloqueados por falta de frame mobile |
