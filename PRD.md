...
| Home | 🚧 | 🚧 | 🚧 En progreso — Header commiteado; menú de navegación y hero (fondo + contenido) esperando aprobación. Sigue el slider del hero |
...
| 7 · Hero — slider de miniaturas | Home | `components/sections/` | [`6008:26358`](https://www.figma.com/design/uuh0qonxt0qkmKJku7jSUd/Sura-Gaming-UX-UI--Copy-?node-id=6008-26358&m=dev) | [`3567:88340`](https://www.figma.com/design/uuh0qonxt0qkmKJku7jSUd/Sura-Gaming-UX-UI--Copy-?node-id=3567-88340&m=dev) | ⏳ Pendiente — el espacio ya está reservado |
