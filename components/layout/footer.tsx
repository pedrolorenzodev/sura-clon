...
export function Footer() {
  return (
    ...
    <footer className="intro-veil flex flex-col gap-6 overflow-x-clip px-gutter pt-section-gap-mobile pb-nav-clearance peer-data-away/bar:pb-gutter-safe desktop:items-center desktop:gap-4 desktop:px-0 desktop:pt-16 desktop:pb-5 desktop:peer-data-away/bar:pb-5">
