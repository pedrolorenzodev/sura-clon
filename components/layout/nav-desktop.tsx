...
export function NavDesktop({ activeId }: { activeId: string | null }) {
  ...
  return (
    <nav
      ...
      className="intro-veil pointer-events-none fixed left-0 top-header-desktop z-40 hidden h-hero-content-desktop w-gutter-desktop items-center px-11 desktop:flex"
    >
      <TooltipProvider>
